...
class ChampModel extends Model
{
    ...
    {
        if(strtotime(date("Y-m-d")) < strtotime($this->takeOneFromTableWhereEqually('DateStartReg','champpages','UrlName',$this->urlName))) {
            return 'err';
        } elseif(strtotime(date("Y-m-d")) >= strtotime($this->takeOneFromTableWhereEqually('DateStartReg','champpages','UrlName',$this->urlName)) && strtotime(date("Y-m-d")) <= strtotime($this->takeOneFromTableWhereEqually('DateEndReg','champpages','UrlName',$this->urlName))) {
            return 'reg';
        } else {
            return 'champ';
        }
